import {
    ...
    GetMonsterMonstersCodeGetRequest,
    ItemsApi,
    MapsApi,
    MonstersApi,
    ResourcesApi,
...
export const getMonster = memo(async (params?: GetMonsterMonstersCodeGetRequest) => {
    return await monstersApi.getMonsterMonstersCodeGet(params ?? { code: "foobar__" });
});
